...
export default class Lifepic extends Component {
    state={paste:[
        ...
        {id:'03',text:'課程名稱：尚硅谷最新版JavaScript基础全套教程完整版(線上學習)',time:'課程時間：2021/2-2021/4',pic:'./media/尚硅谷-JS.jpg'},
        {id:'04',text:'課程名稱：彭彭的課程-HTML/CSS/JavaScript/React/ES6(線上學習)',time:'課程時間：2021/1-2021/3',pic:'./media/彭彭.jpg'},
    ]}
